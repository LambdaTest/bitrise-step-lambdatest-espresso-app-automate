...
run_test_response="$(curl --location --request POST https://mobile-api.lambdatest.com/framework/v1/espresso/build --header "Authorization: Basic ${BASICAUTH}" --header "Content-Type: application/json" --data-raw \ "$json")"
